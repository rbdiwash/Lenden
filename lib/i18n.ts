...
const en = {
  ...
  confirmSampleBody:
    "This replaces your current people and entries with demo data.",
  ...
  personEmptyBody:
    "Record the first len den with {name} using the buttons above.",
  editPersonLabel: "Edit person",
  deletePersonLabel: "Delete person",
  confirmDeletePersonTitle: "Delete {name}?",
  confirmDeletePersonBody:
    "Their entire history will be removed from this device.",
  ...
  selectReturnDate: "Expected return date",
...
const ne: Record<TKey, string> = {
  ...
  personEmptyBody:
    "माथिका बटन प्रयोग गरेर {name} सँगको पहिलो लेनदेन राख्नुहोस्।",
  ...
  selectReturnDate: "फिर्ता आउने मिति",
...
/** Full month names, used by the calendar header. */
...
/** Weekday column headings, starting on Sunday. */
